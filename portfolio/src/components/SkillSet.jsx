...
const TechIcons =  {
  React: () => (
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className='w-6 h-6 animate-spin [animation-delay-6s] [animation-duration:4s]' viewBox="0 0 48 48">
